...
<div class="well">
    <div class="col-lg-6"> 
        <p>
        <strong>
            <?php  if ($_SESSION['user']) { echo 'Welcome ' . ucfirst($_SESSION['user']); echo '<br><br><a href=\'../../logout.php\'>Logout</a>'; } else { echo 'You are not a logged in. <br>Please login to the application and try again.'; } ?>
        </strong>
        </p>
