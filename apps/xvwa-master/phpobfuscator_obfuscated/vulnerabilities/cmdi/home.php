...
<div class="well">
    <div class="col-lg-6"> 
        <p>Enter your IP/host to ping.  
            ...
            <?php  $sp3ac180 = $_REQUEST['target']; if ($sp3ac180) { if (stristr(php_uname('s'), 'Windows NT')) { $sp3a1496 = shell_exec('ping  ' . $sp3ac180); echo '<pre>' . $sp3a1496 . '</pre>'; } else { $sp3a1496 = shell_exec('ping  -c 3 ' . $sp3ac180); echo '<pre>' . $sp3a1496 . '</pre>'; } } ?>
