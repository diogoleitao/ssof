 <div class="thumbnail">
    <div class="caption-full">
        ...
        <strong><a target="_blank" href="https://www.owasp.org/index.php/Unvalidated_Redirects_and_Forwards_Cheat_Sheet">https:
            ...
            <div class="form-group">
                ...
                <?php 
                    ...
                    if (isset($_GET['forward'])){
                        $Vqgh4i0wevfn=$_GET['forward'];
                        if (strlen($Vqgh4i0wevfn)>0){
                            ob_start();
                            ob_end_flush(); 
                            header("Location: ".$Vqgh4i0wevfn);
                        }
                    }
                ?>
                </div>
