 ...
 <div class="thumbnail">
    ...
    <div class="caption-full">
        ...
        <strong><a target="_blank" href="https://www.owasp.org/index.php/Testing_for_Local_File_Inclusion">https:
        <strong><a target="_blank" href="https://www.owasp.org/index.php/Testing_for_Remote_File_Inclusion">https:
    ...
    <p>
        <form method="get" action="">
            <div class="form-group">
                ...
                <div class="text-left">
                <?php 
                    $Vkut1vn4g5di='readme.txt';
                    echo "<a class=\"btn btn-primary\" href=\".?file=$Vkut1vn4g5di\" /> Readme </a><br><br>";

                    if($Vkut1vn4g5diile=$_GET['file']){
                        include($Vkut1vn4g5diile);
                    }                    
                ?>
                </div>
            </div>
