...
<?php
   ...
   $Vkeo4lqlzrqy = mysql_query ("SELECT name,guess,count,tod FROM
                          guessnumresults WHERE count =1 order by tod", $V5vokl1wwmg3);
   $Vbeaqgmfwptj = mysql_num_rows($Vkeo4lqlzrqy); 

print "<H2>Below please find all $Vbeaqgmfwptj Guessnum players in the database with perfect scores.\n<hr>" ;
