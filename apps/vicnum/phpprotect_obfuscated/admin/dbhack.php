...
<?php
   ...
   $Vkeo4lqlzrqy = mysql_query ("SELECT name,guess,count,tod FROM
                          results WHERE (count >0  AND name like  \"55Broadway%\") order by tod", $V5vokl1wwmg3);
   $Vbeaqgmfwptj = mysql_num_rows($Vkeo4lqlzrqy); 

print "<H2>Below are all $Vbeaqgmfwptj Vicnum players who have clearly hacked the game and the database.\n<hr>" ;
