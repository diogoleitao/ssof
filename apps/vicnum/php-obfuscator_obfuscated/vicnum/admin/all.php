...
<?php  $sp5b2588 = mysql_connect('localhost', 'root', 'vicnum'); mysql_select_db('vicnum', $sp5b2588); $sp85efff = mysql_query('SELECT name,guess,count,tod FROM
                          results where count > 0 order by count,tod asc', $sp5b2588); $sp65e572 = mysql_num_rows($sp85efff); print "<H2>Below please find all {$sp65e572} Vicnum players in the database.\n<hr>"; while ($spa05ab6 = mysql_fetch_array($sp85efff, MYSQL_NUM)) { print "{$spa05ab6['0']} has guessed {$spa05ab6['1']} in {$spa05ab6['2']} guess(es) on {$spa05ab6['3']} \n"; } ?>
</pre>
<p><p>
