...
<?php  echo "<h3>You have requested results for Guessnum player {$spf97a4b} :"; $sp5b2588 = mysql_connect('localhost', 'root', 'vicnum'); mysql_select_db('vicnum', $sp5b2588); $sp1cf139 = "SELECT name,guess,count,tod FROM guessnumresults WHERE name  = '{$spf97a4b}'"; $sp85efff = mysql_query($sp1cf139) or die("ERROR in {$sp1cf139}" . ' ' . mysql_error()); if (mysql_num_rows($sp85efff) > 0) { while ($spa05ab6 = mysql_fetch_array($sp85efff, MYSQL_NUM)) { print '
